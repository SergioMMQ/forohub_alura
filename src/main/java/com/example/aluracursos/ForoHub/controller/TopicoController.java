package com.example.aluracursos.ForoHub.controller;

import com.example.aluracursos.ForoHub.domain.topico.*;
...
public class TopicoController {
    ...
    public ResponseEntity<DatosRespuestaTopico> registrarTopico(@RequestBody @Valid DatosRegistroTopico datosRegistroTopico,
        ...
        DatosRespuestaTopico datosRespuestaTopico = new DatosRespuestaTopico(topico.getId(), topico.getTitulo(),
                topico.getMensaje(), topico.getFechaDeCreacion(), topico.isEstadoDeActividad(), topico.getAutor(),
    ...
    public ResponseEntity listarUnSoloTopico(@PathVariable Long id) {
        ...
        var datosTopico = new DatosRespuestaTopico(topico.getId(), topico.getTitulo(),
                topico.getMensaje(), topico.getFechaDeCreacion(), topico.isEstadoDeActividad(),
    ...
    public ResponseEntity actualizarTopico(@RequestBody @Valid DatosActualizarTopico datosActualizarTopico) {
        ...
        return ResponseEntity.ok(new DatosRespuestaTopico(topico.getId(), topico.getTitulo(), topico.getMensaje(),
                topico.getFechaDeCreacion(), topico.isEstadoDeActividad(), topico.getAutor(), topico.getNombreCurso()));
    }
